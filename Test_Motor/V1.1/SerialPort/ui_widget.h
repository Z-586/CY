...
"border-color:rgb(222,222,222);"));
        ...
        gridLayout_2->addLayout(verticalLayout, 6, 2, 2, 1);
        ...
        gridLayout_2->addLayout(horizontalLayout_12, 5, 2, 1, 1);
...
"border-color:rgb(222,222,222);"));
        ...
        gridLayout_2->addLayout(gridLayout, 0, 0, 8, 2);
...
"border-color:rgb(222,222,222);"));
        ...
        label_20->setMinimumSize(QSize(102, 30));
        label_20->setMaximumSize(QSize(102, 30));
        label_20->setStyleSheet(QString::fromUtf8("border-width: 1px;\n"
"border-style:solid;\n"
"border-color:rgb(222,222,222);"));

        horizontalLayout_13->addWidget(label_20);

        TX_Temp = new QLineEdit(Widget);
        TX_Temp->setObjectName(QString::fromUtf8("TX_Temp"));
        TX_Temp->setMinimumSize(QSize(100, 30));
        TX_Temp->setMaximumSize(QSize(100, 30));
        TX_Temp->setReadOnly(true);

        horizontalLayout_13->addWidget(TX_Temp);

        label_21 = new QLabel(Widget);
        label_21->setObjectName(QString::fromUtf8("label_21"));
        label_21->setMinimumSize(QSize(102, 30));
        label_21->setMaximumSize(QSize(102, 30));
        label_21->setStyleSheet(QString::fromUtf8("border-width: 1px;\n"
"border-style:solid;\n"
"border-color:rgb(222,222,222);"));

        horizontalLayout_13->addWidget(label_21);

        RX_Temp = new QLineEdit(Widget);
        RX_Temp->setObjectName(QString::fromUtf8("RX_Temp"));
        RX_Temp->setMinimumSize(QSize(100, 30));
        RX_Temp->setMaximumSize(QSize(100, 30));
        RX_Temp->setReadOnly(true);

        horizontalLayout_13->addWidget(RX_Temp);


        gridLayout_2->addLayout(horizontalLayout_13, 3, 2, 1, 1);
    ...
    void retranslateUi(QWidget *Widget)
    {
        ...
        label_20->setText(QCoreApplication::translate("Widget", "\345\217\221\345\260\204\347\253\257\346\270\251\345\272\246(\342\204\203) \357\274\232", nullptr));
        label_21->setText(QCoreApplication::translate("Widget", "\346\216\245\346\224\266\347\253\257\346\270\251\345\272\246(\342\204\203) \357\274\232", nullptr));
    } // retranslateUi
