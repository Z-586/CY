...
void Motor_Init(void)
{
	...
	GPIO_InitStructure.GPIO_Pin = GPIO_Pin_3 | GPIO_Pin_8 | GPIO_Pin_11 | GPIO_Pin_0 | GPIO_Pin_12 | GPIO_Pin_1| GPIO_Pin_4;
	GPIO_InitStructure.GPIO_Speed = GPIO_Speed_50MHz;
	GPIO_Init(GPIOA, &GPIO_InitStructure);
	
	GPIO_ResetBits(GPIOA,GPIO_Pin_3 |  GPIO_Pin_8 | GPIO_Pin_11 | GPIO_Pin_0 | GPIO_Pin_12 | GPIO_Pin_1| GPIO_Pin_4);
}
