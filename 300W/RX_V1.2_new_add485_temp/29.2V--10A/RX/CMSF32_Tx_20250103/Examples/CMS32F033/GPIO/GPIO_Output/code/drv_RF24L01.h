...
/**********************************************************************************************************/
//NRF24L01控制操作
#define RF24L01_CE_GPIO_PORT			GPIO0
#define RF24L01_CE_GPIO_PIN				GPIO_PIN_1

#define RF24L01_IRQ_GPIO_PORT			GPIO0
#define RF24L01_IRQ_GPIO_PIN			GPIO_PIN_0

#define RF24L01_CS_GPIO_PORT			SPI_NSS_GPIO_PORT			//P04
...
/** 口线操作函数定义 */
//NRF2401片选信号
#define RF24L01_SET_CE_HIGH( )			RF24L01_CE_GPIO_PORT->DO_f.P1 = 1
#define RF24L01_SET_CE_LOW( )			RF24L01_CE_GPIO_PORT->DO_f.P1 = 0
...
//NRF2401_IRQ数据输入
#define RF24L01_GET_IRQ_STATUS( )		(GPIO0->DI_f.P0 == 0) ? 0 : 1	//IRQ状态
