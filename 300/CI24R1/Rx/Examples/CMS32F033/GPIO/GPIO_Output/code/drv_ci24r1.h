...
#define CI24R1_DATA_OUT()			do{ SYS_SET_IOCFG(IOP05CFG,SYS_IOCFG_P05_GPIO);	GPIO_CONFIG_IO_MODE(GPIO0, GPIO_PIN_5, GPIO_MODE_OUTPUT); GPIO0->DO_f.P5 = 1;}while(0)
#define CI24R1_DATA_IN()			do{ SYS_SET_IOCFG(IOP05CFG,SYS_IOCFG_P05_GPIO);	GPIO_CONFIG_IO_MODE(GPIO0, GPIO_PIN_5, GPIO_MODE_INPUT); GPIO0->DO_f.P5 = 1;}while(0)

#define CI24R1_CLK_HIGH()			GPIO0->DO_f.P7 = 1
#define	CI24R1_CLK_LOW()			GPIO0->DO_f.P7 = 0

#define CI24R1_NSS_HIGH()			GPIO0->DO_f.P4 = 1
#define	CI24R1_NSS_LOW()			GPIO0->DO_f.P4 = 0

#define CI24R1_DATA_HIGH()		GPIO0->DO_f.P5 = 1
#define	CI24R1_DATA_LOW()			GPIO0->DO_f.P5 = 0

#define CI24R1_READ()				  GPIO0->DO_f.P5
