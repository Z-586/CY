...
uint16_t V_Set(float V_set_number){
	return 4096.0*15/215/5.0*V_set_number;//55V
}

static uint8_t OVER_V_FLAG = 0;

#define I_MIN I_Set(4.5 - Temp_State) 
#define I_MAX I_Set(5.1 - Temp_State) 
#define I_Max I_Set(12)  
#define I_Max_Run I_Set(6)  
#define I_Fall I_Set(0.5)  

#define V_MAX V_Set(Target_V+0.1)
#define V_FALL_MAX V_Set(54)
#define Temp_MAX 85  
#define V_Max V_Set(Target_V + 2)  
#define Check_V_MIN V_Set(30)  
#define Check_V_MAX V_Set(65)  
