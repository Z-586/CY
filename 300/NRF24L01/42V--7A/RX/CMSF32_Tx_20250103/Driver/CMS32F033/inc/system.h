 ...
 **System  外设时钟
-----------------------------------------------------------------------------*/
#define 	SYS_CLK_ADC1_MSK		(SYS_APBCKEN_ADC1CE_Msk)	/*ADC1时钟使能位*/
#define 	SYS_CLK_ACMP_MSK		(SYS_APBCKEN_ACMPCE_Msk)	/*模拟比较器时钟使能位*/
#define 	SYS_CLK_OPA_PGA_MSK		(SYS_APBCKEN_OP_PGACE_Msk)	/*运放/GPA时钟使能位*/
...
#define 	SYS_CLK_TIMER01_MSK		(SYS_APBCKEN_TIMER01CE_Msk)	/*定时器时钟使能位*/
